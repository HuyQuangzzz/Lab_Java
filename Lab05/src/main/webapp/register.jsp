          ...
          <form method="post" action="register">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input id="name" value="${username}" name="username" type="text" class="form-control" placeholder="Your Name">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input id="email" value="${email}" name="email" type="text" class="form-control" placeholder="Email">
              </div>
            ...
            <c:if test="${passwordError}">
              <div class="form-group">
                <div class="alert alert-danger alert-dismissible fade show">
                  ...
                  Password must have at least 6 characters or Passwords do not match!
                </div>
              </div>
            </c:if>
