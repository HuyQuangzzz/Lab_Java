        ...
        <div class="col col-md-6 card mt-5 p-3">
            <form method="post" action="/UploadServlet" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input  name="fileName" placeholder="This name will be used to save the file after uploading to server" id="name" type="text" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group custom-control custom-checkbox">
                    <input type="checkbox" name="checkbox" class="custom-control-input" id="override">
