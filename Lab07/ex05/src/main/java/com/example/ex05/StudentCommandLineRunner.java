...
import com.example.ex05.repositories.StudentRepository;
...
public class StudentCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Iterable<Student> studentage = studentRepository.findByAge(22);
        ...
        Iterable<Student> studentName = studentRepository.findByName("A");
